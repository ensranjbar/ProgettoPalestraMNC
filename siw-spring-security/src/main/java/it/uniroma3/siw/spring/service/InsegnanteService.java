...
public class InsegnanteService {
	...
	@Transactional
	public List<Insegnante> InsegnantePerNomeAndCognome(String nome, String cognome) {
		return insegnanteRepository.findByNomeAndCognome(nome, cognome);
	}
	
	@Transactional
	public List<Insegnante> InsegnantePerNomeOrCognome(String nome, String cognome) {
		return insegnanteRepository.findByNomeOrCognome(nome, cognome);
	}
