...
public class LezioneValidator implements Validator {
	...
	return Lezione.class.equals(clazz);
	}
	...
	public void validate(Object o, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "insegnante", "required");

		if (!errors.hasErrors()) {
			logger.debug("confermato: valori non nulli");
			if (this.lezioneService.alreadyExists((Lezione)o)) {  // da sistemare
